...
public enum TransactionType {
	...
	/**SENT_REMINDERS**/
	SENT_REMINDERS(6103, "Admin sent appointment reminders to patients", "sent reminders", true),
	/**CREATE_OBS_VISIT**/
	CREATE_OBS_VISIT(6400, "Create Obstetric Office Visit", "created obstetrics visit", true),
	/**VIEW_OBS_VISIT**/
	VIEW_OBS_VISIT(6401, "View Obstetric Office Visit", "viewed obstetrics visit", true),
	/**EDIT_OBS_VISIT**/
	EDIT_OBS_VISIT(6402, "Edit Obstetric Office Visit", "editted obstetrics visit", true),
	/**FEATURE_DISABLED **/
	FEATURE_DISABLED(6104, "Tester Disabled/Enabled a Feature", "disabled/enabled a feature", false);
	/**
