...
public class PatientDAO {
	...
	/**
	 * Returns all patients that have appointments coming up within a certain amount of days
	 ...
	 * @throws DBException
	 */
	public List<PatientBean> getPatientsForReminders(int numDaysInAdvance) throws DBException {
