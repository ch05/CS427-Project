...
public class PatientNavigation implements Tag {
	...
	private String pageTitles[] = { "Health Records", "Basic Health History", "Demographics",
			"Document Office Visit", "Risk Factors", "Prescriptions", "Obstetrics Records" };
	private String pageURLs[] = { "editPHR.jsp", "viewBasicHealth.jsp", "editPatient.jsp",
			"documentOfficeVisit.jsp", "chronicDiseaseRisks.jsp", "getPrescriptionReport.jsp", "OBInitialization.jsp" };
