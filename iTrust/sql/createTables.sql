...
CREATE TABLE obinit(
	...
	LMP DATE NOT NULL,
	pregID int NOT NULL,
	FOREIGN KEY (pregID) REFERENCES pregnancy(id),
	PRIMARY KEY (id)
) Engine=MyISAM;
...
CREATE TABLE pregnancy(
	id int NOT NULL AUTO_INCREMENT,
	YOC int NOT NULL,
	numWeeksPregnant VARCHAR(5) NOT NULL,
	numHoursLabor double,
	deliveryType VARCHAR(30) NOT NULL,
	PRIMARY KEY (id)
) Engine=MyISAM;

CREATE TABLE obvisit(
	id int NOT NULL AUTO_INCREMENT,
	...
	fundalHeight double NOT NULL,
	PRIMARY KEY (id)
) Engine=MyISAM;

CREATE TABLE obinit_obvisit_link (
	id int NOT NULL AUTO_INCREMENT,
	visitID int NOT NULL REFERENCES obvisit(id),
	initID int NOT NULL REFERENCES obinit(id),
	PRIMARY KEY (id)
) Engine=MyISAM;

CREATE TABLE features(
	id INT(11) NOT NULL AUTO_INCREMENT,
	feature_name VARCHAR(60) UNIQUE,
...
CREATE TABLE error(
	...
	user_id BIGINT unsigned REFERENCES users(MID),
	message TEXT,
...
CREATE TABLE request(
	...
	requestedPage VARCHAR(255),
	contentLength INT(11),
    host VARCHAR(255),
