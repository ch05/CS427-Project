...
public class BillingDAOTest {
	...
	/**
	 * Test method for {@link edu.ncsu.csc.itrust.dao.mysql.BillingDAO#getBillId(long)}.
	 * @throws DBException 
	 */
	@Test
	public void TestGetBillId(){
		...
		try{
			billingDAO.addBill(b1);
			assertEquals(null, billingDAO.getBillId(0));
		} catch(DBException e){
			fail();
		}
	}
	...
	/**
	 * Test method for {@link edu.ncsu.csc.itrust.dao.mysql.BillingDAO#getUnpaidBills(long)}.
	 * @throws DBException 
	 */
	@Test
	public void TestGetUnpaidBills(){
		...
		try{
			billingDAO.addBill(b1);
			List<BillingBean> unpaid = billingDAO.getUnpaidBills(PATIENT_MID);
	 ...
	 */
	@Test
	public void testAddBillException() throws Exception {
		try {
			evilDAO.addBill(b1);
	 ...
	 */
	@Test
	public void testGetPendingNumException() throws Exception {
		try {
