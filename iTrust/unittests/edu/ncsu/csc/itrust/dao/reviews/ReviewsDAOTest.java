...
public class ReviewsDAOTest {
    ...
    private ReviewsDAO evilDAO = EvilDAOFactory.getEvilInstance().getReviewsDAO();
	...
	public final void testAddReviewValid() {
	    try {
			...
			//assertTrue(0.0 == rdao.getAverageRating(PID1));
		} catch (DBException e) {
			fail();
		}
