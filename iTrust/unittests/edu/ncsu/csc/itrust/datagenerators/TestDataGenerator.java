...
public class TestDataGenerator {
	...
	public void error1() throws FileNotFoundException, IOException, SQLException {
		new DBBuilder(factory).executeSQLFile(DIR + "/error1.sql");
	}
	...
	public void hcpUC63() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/hcpUC63.sql");
	}
	...
	public void obinit1() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/obinit1.sql");
	} //NEW

	public void obinit2() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/obinit2.sql");
	} //NEW
	
	public void obinit3() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/obinit3.sql");
	} //NEW
	
	public void obvisit1() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/obvisit1.sql");
	} //NEW
	...
	public void response1() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/response1.sql");
	}
	
	public void request1() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/request1.sql");
	}
	...
	public void admin4() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/admin4.sql");
	}
	...
	public void features() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/features.sql");
	}
