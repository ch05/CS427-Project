...
//		gen.testExpertSearch();
	...
	//Newly added test case to cover the comparator class
	public void testGetExpertsList() throws DBException{
		System.out.println("Begin testGetExpertsList - Newly added test case in ZipCodeActionTest.java to increase coverage in Part2.4");
		List<PersonnelBean> admins = zipCodeAction.getExperts("All", "10453", "20000");
		System.out.println("Number of admins in the database: " + admins.size());
		for(PersonnelBean pb : admins){
			System.out.println(pb.getFullName());
//			System.out.println( pb.getMID() );
		}
