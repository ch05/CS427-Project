...
<div class="panel panel-default">
	...
	<div class="panel-body" id="other-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/hcp/viewCODTrends.jsp">View Cause of Death Trends</a>
			<li><a href="/iTrust/auth/hcp-uap/OBInitialization.jsp">Obstetrics Patient Initialization</a>
