...
<%
pageTitle = "iTrust - View Sent Reminders";
...
<%
loggingAction.logEvent(TransactionType.OUTBOX_VIEW, 9000000089L, 9000000089L, "");
	ViewMyMessagesAction action = new ViewMyMessagesAction(prodDAO, 9000000089L);
