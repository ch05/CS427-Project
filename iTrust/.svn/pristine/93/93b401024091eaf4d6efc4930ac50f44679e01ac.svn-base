...
public class ObstetricsDAO {
	...
	/**
	 * Returns a list of dates of patient obstetric initializations
	 * @param patientMID MID of the patient
	...
	/**
	 * Inserts a patient into the obstetrics table
	 * @param ob ObstetricsBean for the patient
	 * @return True if record inserted, false otherwise
	 * @throws ITrustException
	 * @throws DBException
	 */
	...
	/**
	 * Inserts information into the database about an obstetrics office visit
	...
	/**
	 * Gets the record for a patient for a specified date
	 * @param patientMID MID of the desired patient
	 * @param d Date of the patient's initialization
	 * @return ObstetricsBean for the initialization visit
	 * @throws ITrustException
	 * @throws DBException
	 */
	...
	/**
	 * Returns an ObstetricsBean with information related to an Obstetrics office visit
