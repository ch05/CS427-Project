...
<div class="panel panel-default">
	...
	<div class="panel-body" id="other-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/admin/sendReminder.jsp">Send Reminder</a></li>
			<li><a href="/iTrust/auth/admin/messageOutbox.jsp">Reminder Outbox</a></li>
			<li><a href="/iTrust/auth/admin/transactionLog.jsp">Transaction Log</a></li>
		</ul>
	</div>
</div>