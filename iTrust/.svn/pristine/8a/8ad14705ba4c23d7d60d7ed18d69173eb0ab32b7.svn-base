...
DELETE FROM obinit;
ALTER TABLE obinit AUTO_INCREMENT = 0;
DELETE FROM obvisit;
ALTER TABLE obvisit AUTO_INCREMENT = 0;
DELETE FROM obinit_obvisit_link;
ALTER TABLE obinit AUTO_INCREMENT = 0;

DELETE FROM features;
ALTER TABLE features AUTO_INCREMENT = 0;

DELETE FROM error;
ALTER TABLE error AUTO_INCREMENT = 0;

DELETE FROM response;
ALTER TABLE response AUTO_INCREMENT = 0;

DELETE FROM request;
ALTER TABLE request AUTO_INCREMENT = 0;